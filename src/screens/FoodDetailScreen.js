...
const recommendedItems = [
  {
    ...
    price: 130,
    image:
      "https://static.vecteezy.com/system/resources/thumbnails/048/067/082/small_2x/biryani-dish-malabar-biryani-with-thalassery-chicken-isolated-illustration-on-a-transparent-background-png.png",
  },
  {
    id: "2",
    name: "Chicken",
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity  onPress={() => navigation.navigate("DeliveryAddress",[item])}
